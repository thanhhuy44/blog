...
function Home() {
  ...
  return loading ? (
    <div className="container mx-auto m-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
      <CardLoading />
      <CardLoading />
      <CardLoading />
      <CardLoading />
    ...
    <>
        ...
        {popularBlogs.length
          ? popularBlogs.map((item, index) => (
              <SwiperSlide className="!h-auto" key={index}>
                <div className="block relative h-full sm:aspect-[21/9]">
                  <Image
                    src={item.banner}
                    fill
                    alt="banner"
                    className="!static w-full sm:aspect-[21/9] object-cover object-center"
                  />
                  <div className="absolute left-0 top-0 right-0 bottom-0 bg-black/50 ">
                    <div className="container mx-auto py-8 sm:py-24 flex h-full items-end justify-between">
                      <div className="flex-1 flex flex-col gap-y-2 sm:gap-y-4">
                        <p className="text-[#e5e5e5] text-xs font-light sm:leading-5">
                        ...
                        <Link
                          ...
                          className="text-[#f8f9fa] text-lg sm:text-2xl font-bold sm:leading-10 max-w-[600px] line-clamp-2 sm:line-clamp-4 2xl:line-clamp-none">
                          <h3>{item.title}</h3>
                        </Link>
                        <p className="text-[#e5e5e5] text-xs font-light leading-5 line-clamp-2 sm:line-clamp-4 2xl:line-clamp-none">
                          {item.description}
                        </p>
                      </div>
                    </div>
      ...
      <div className="container mx-auto my-12 sm:my-24">
        <h1 className="text-[#495057] text-2xl font-medium leading-5">
          {`Editor's Picks`}
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-14 mb-16">
          ...
          <div className="relative w-full h-full aspect-[3/4] rounded overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/50 flex items-end">
              <div className="flex-1 flex flex-col gap-y-4 sm:mb-12 sm:ml-12 p-4 sm:p-0">
      ...
      <div className="mx-auto container mb-24">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-8 gap-y-11">
          {latestBlogs.length
