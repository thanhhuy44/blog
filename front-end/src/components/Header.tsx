  ...
  return (
    ...
    >
      <div className="container w-full mx-auto flex items-center justify-between py-4">
        <Link className="text-[#495057] text-lg font-bold leading-6" href={"/"}>
          VENCE
        </Link>
          ...
          {isLogin ? (
            ...
            >
              ...
              >
                <Link
                  href={"/profile"}
                  className="select-none p-2 flex items-center gap-x-2 cursor-pointer hover:bg-gray-200 duration-300"
                >
                  <User size={20} />
